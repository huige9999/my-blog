---
title: NestJS 教程 14：ORM
date: 2026-03-03
description: NestJS 中 TypeORM 的使用，包括 ORM 的概念、实体定义、CRUD 操作以及多表关系处理
---
...
**一对多/多对一**关系是我们最常见的关系，班级和学生，部门和员工，可以拿这些简单的内容来举例。比如部门和员工(一个部门可以有多个员工，一个员工只属于一个部门)
...
![EntityManager需要传入实体](/assets/44.png)
